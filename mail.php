...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $content = $name . ' записался к мастеру ' . $man . ', на услугу ' . $services . ' в ' . $time . ',' . $data . 'года. Его номер: ' . $number;
    ...
    $success = mail("admin@barbershop.com ", 'Запрос на услугу', $content, $headers);
